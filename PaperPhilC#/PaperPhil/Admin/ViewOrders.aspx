<%@ Page Title="Pending Orders" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewOrders.aspx.cs" Inherits="PaperPhil.ViewOrders" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <section>
        <div>
            ...
            <asp:ListView ID="OrderList" runat="server" DataKeyNames="OrderId" GroupItemCount="2" ItemType="PaperPhil.Models.Order" SelectMethod="GetUser">
                <EmptyDataTemplate>
                    <table>
                        <tr>
